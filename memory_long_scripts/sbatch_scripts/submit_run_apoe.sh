...
if [ -e logs/slurm.apoe.$feature.txt ]; then
	exit 1
fi

mv logs/slurm-${SLURM_JOBID}.txt logs/slurm.apoe.$feature.txt


Rscript /cluster/projects/p274/projects/p039_image_brain/scripts/memory_long_scripts/sbatch_scripts/run_apoe.R $feature $wd
